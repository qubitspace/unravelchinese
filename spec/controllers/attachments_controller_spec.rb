...
RSpec.describe AttachmentsController, type: :controller do
  ...
  # Attachments. As you add validations to Attachments, be sure to
  ...
  # AttachmentssController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "assigns the requested attachment as @attachment" do
      attachment = Attachments.create! valid_attributes
  ...
  describe "GET #new" do
    it "assigns a new attachment as @attachment" do
      ...
      expect(assigns(:attachment)).to be_a_new(Attachments)
    end
  end
